package com.rifa.backend.entity;
...
public class Data {
	...
	public String getNamaCJabatan() {
		return namaCJabatan;
	}
	public void setNamaCJabatan(String namaCJabatan) {
		this.namaCJabatan = namaCJabatan;
	}
	private int kodeJabatan;
    private String namaCJabatan;
